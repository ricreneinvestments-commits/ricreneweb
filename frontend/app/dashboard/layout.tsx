    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-20 h-14">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-full flex items-center justify-between gap-3">
          ...
          {/* Right: user initials + Back to Website + Sign out */}
          <div className="flex items-center gap-2">

            {/* User initials + name — desktop only */}
            ...
            <button
              onClick={logout}
              className="text-xs text-gray-400 hover:text-red-600 transition-all px-3 py-1.5 rounded-lg font-medium border border-gray-200 hover:border-red-200 hover:bg-red-50"
            >
              Sign out
            </button>
