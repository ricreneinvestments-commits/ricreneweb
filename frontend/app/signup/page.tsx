...
export default function SignupPage() {
  ...
  const inputBase =
    "w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-gray-900 placeholder-gray-400 focus:outline-none focus:bg-white transition-all text-sm";
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-gray-950 relative overflow-hidden flex-col justify-between p-14">
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-400 text-base leading-relaxed max-w-xs">
            Create your free client account and get instant access to project tracking,
            invoices, and direct support.
          </p>
          ...
          <div className="mt-10 bg-white/5 border border-white/10 rounded-2xl p-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed italic">
              &quot;The client portal made it so easy to track our website project from start to finish.&quot;
            </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input type="tel" value={form.phone}
                ...
                placeholder="+255 700 000 000" className={inputBase}
                onFocus={focusStyle} onBlur={blurStyle} />
            </div>
            ...
            <div>
              ...
              <input
                type={showPass ? "text" : "password"} required value={form.confirm}
                onChange={(e) => update("confirm", e.target.value)}
                placeholder="Repeat your password"
                className={`${inputBase}${form.confirm && form.confirm !== form.password ? " !border-red-300 !bg-red-50" : ""}`}
                onFocus={focusStyle} onBlur={blurStyle}
              />
            ...
            <p className="text-xs text-gray-400 leading-relaxed pt-1">
              ...
              <Link href="/privacy" className="text-gray-600 underline hover:underline" style={{ color: BRAND }}>
                Privacy Policy
              </Link>.
            </p>
            ...
            <button
              ...
              className="w-full text-white py-3.5 rounded-xl font-semibold transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm"
