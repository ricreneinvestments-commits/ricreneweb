...
const approaches = [
  {
    ...
    description: "We focus on delivering exceptional work rather than rushing through projects. Every solution is crafted with attention to detail and built to last.",
  },
  {
    id: 2,
    icon: (
    ...
    description: "No technical jargon, no confusing terms. We explain everything in plain language and keep you informed at every step of the process.",
  },
  {
    id: 3,
    icon: (
    ...
    description: "We use the latest tools and frameworks to build fast, secure, and scalable solutions that give your business a competitive edge.",
  },
  {
    id: 4,
    icon: (
    ...
    description: "No hidden fees, no surprise charges. You'll know exactly what you're paying for before we start, with flexible payment options available.",
  },
  {
    id: 5,
    icon: (
    ...
    description: "We don't disappear after delivery. We provide training, documentation, and continued support to ensure your success long-term.",
  },
  {
    id: 6,
    icon: (
    ...
    description: "We understand the Tanzanian market, local business needs, and the challenges you face. Solutions tailored for your reality, not copy-pasted from abroad.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-600">
            We&apos;re building our reputation one project at a time. Here&apos;s what sets us apart and what you can expect when working with Ricrene Investment.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-lg text-gray-600 mb-6">
            Ready to start your project with a team that puts your success first?
          </p>
          <a
            href="#contact"
