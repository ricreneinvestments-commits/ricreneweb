...
// ── Only real, existing pages ─────────────────────────────────────────────────
const serviceLinks = [
  { label: "Website Design & Maintenance", href: "/services/website-design"      },
  { label: "Photography & Media",          href: "/services/photography-media"   },
...
const quickLinks = [
  ...
  { label: "Why Us",         href: "/#why-us",   scroll: true  },
  { label: "Our Process",    href: "/#process",  scroll: true  },
  { label: "Contact Us",     href: "/#contact",  scroll: true  },
  { label: "Login",          href: "/login",     scroll: false },
  { label: "Privacy Policy", href: "/privacy",   scroll: false },
];
...
// ── Shared hover helpers — fixes the syntax error in anchor onMouseLeave ──────
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-12">
          ...
          <div className="lg:col-span-4">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="text-white text-lg font-bold">Ricrene Investment Ltd</h3>
            </div>
          ...
          <div className="lg:col-span-3">
            <h4 className="text-white font-semibold mb-5 text-sm">Our Services</h4>
          ...
          <div className="lg:col-span-2">
            <h4 className="text-white font-semibold mb-5 text-sm">Quick Links</h4>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    onClick={link.scroll ? (e) => handleScrollLink(e, link.href) : undefined}
                    className="text-gray-400 hover:text-white transition-colors text-xs flex items-center gap-2 group"
                  >
                    <svg
                      className="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity shrink-0"
          ...
          {/* ── Contact ───────────────────────────────────────────────────── */}
          <div className="lg:col-span-3">
            <h4 className="text-white font-semibold mb-5 text-sm">Get In Touch</h4>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <a
                  ...
                  className="text-gray-400 hover:text-white transition-colors text-xs break-all"
                >
                  {contact.email}
                </a>
              </li>
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400 text-xs">{contact.address}</span>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-500 text-center md:text-left">
            © {currentYear} Ricrene Investment Ltd. All rights reserved. Built with excellence in Tanzania.
          </p>
          <div className="flex items-center gap-4 text-xs text-gray-600">
            <a href="/privacy" className="hover:text-gray-400 transition-colors">Privacy Policy</a>
            <span>·</span>
            <span>ricreneinvestment.co.tz</span>
          </div>
        </div>
      </div>
    </footer>
